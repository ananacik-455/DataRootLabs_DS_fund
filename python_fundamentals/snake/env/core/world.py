...
class World(object):
    def __init__(self, size, custom, start_position, start_direction_index, food_position):
        ...
        self.world[0] = self.WALL # first row
        self.world[:,0] = self.WALL # first column
        self.world[-1] = self.WALL # last row
        self.world[:,-1] = self.WALL # last column
    ...
    def init_snake(self):
        ...
        if not self.custom:
            ...
            start_position = tuple([random.randint(SNAKE_SIZE, self.size[0] - SNAKE_SIZE),
    ...
    def init_food(self):
        ...
        self.current_available_food_positions = self.available_food_positions - set(snake.blocks)
        if not self.custom:
    ...
    def move_snake(self, action):
        ...
        if self.snake.alive:
            ...
            if self.world[new_snake_head[0], new_snake_head[1]] == WALL:
            ...
            if new_snake_head == self.food_position:
                ...
                self.snake.blocks.append(tuple(old_snake_tail))
